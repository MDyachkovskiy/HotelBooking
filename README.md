...
<table>
  <tr>
    ...
    <td width="800">
      ...
      <li>Информация о клиенте: Поля для номера телефона (с автоматической маской для форматирования +7 (ХХХ) ХХХ-ХХ-ХХ) и электронной почты (со стандартной валидацией).</li>
...
<table>
  <tr>
    <td width="400" height="650">
      <img src="https://gdurl.com/guhL" width="250" height="520" />
    </td>
    <td width="800">
      <p>В приложении реализован удобный механизм выбора даты для пользовательских полей ввода, работающих с датами. При получении фокуса таким EditText, автоматически отображается диалоговое окно DatePickerDialog, позволяющее пользователю выбрать дату в удобном графическом интерфейсе. </p>   
    </td>
  </tr>
</table>
